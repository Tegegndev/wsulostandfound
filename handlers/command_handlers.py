...
def register_command_handlers(bot):
    ...
    def cmd_search(message: telebot.types.Message):
        try:
            ...
            report_to_admin(bot, "cmd_search", e)
            bot.reply_to(message, "An error occurred. Please try again later.")
    ...
    def cmd_post_lost(message: telebot.types.Message):
        try:
            ...
            logger.exception("cmd_post_lost failed")
            report_to_admin(bot, "cmd_post_lost", e)
            bot.reply_to(message, "An error occurred. Please try again later.")
    ...
    def cmd_post_found(message: telebot.types.Message):
        try:
            ...
            logger.exception("cmd_post_found failed")
            report_to_admin(bot, "cmd_post_found", e)
            bot.reply_to(message, "An error occurred. Please try again later.")
